...
W='\033[0m'
# The Credit For This Code Goes To SpeedX And All Other Contributors Listed At https://github.com/1ucif3r/HxBomb
...
def banner():
  ...
  __    __          _______                        __                         
|  \  |  \        |       \                      |  \                        
| ▓▓  | ▓▓__    __| ▓▓▓▓▓▓▓\ ______  ______ ____ | ▓▓____   ______   ______  
| ▓▓__| ▓▓  \  /  \ ▓▓__/ ▓▓/      \|      \    \| ▓▓    \ /      \ /      \ 
| ▓▓    ▓▓\▓▓\/  ▓▓ ▓▓    ▓▓  ▓▓▓▓▓▓\ ▓▓▓▓▓▓\▓▓▓▓\ ▓▓▓▓▓▓▓\  ▓▓▓▓▓▓\  ▓▓▓▓▓▓\
| ▓▓▓▓▓▓▓▓ >▓▓  ▓▓| ▓▓▓▓▓▓▓\ ▓▓  | ▓▓ ▓▓ | ▓▓ | ▓▓ ▓▓  | ▓▓ ▓▓    ▓▓ ▓▓   \▓▓
| ▓▓  | ▓▓/  ▓▓▓▓\| ▓▓__/ ▓▓ ▓▓__/ ▓▓ ▓▓ | ▓▓ | ▓▓ ▓▓__/ ▓▓ ▓▓▓▓▓▓▓▓ ▓▓      
...
def infinite(pn, dl, ch, max):
    ...
    while True:
        ...
        count_inf += 1
        # os.system('echo 1ucif3r >> count.xxx')
        time.sleep(float(dl))
        if (count_inf > maxlim):
            exit()
...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        try:
            ...
            if cc == "91":
                print('Sorry All APIs Have Expired Please Update HxBomb')
                ...
                if success > 0:
                    ...
                    print(
                        '\t\tPlease Send A Mail To hknja1832853kminjafcku69 To Let Us Know...')
                    input('Press Enter To Exit...')
                    exit()
        ...
        print("              This Bomber Was Created By 1ucifer !!                ")
        print("==================================================================")
        try:
...
def update():
    ...
    for fl in stuff_to_update:
        dat = urllib.request.urlopen(
            "https://raw.githubusercontent.com/1ucif3r/HxBomb/master/" + fl).read()
        file = open(fl, 'wb')
        file.write(dat)
        file.close()
    print('\n\t\tUpdated Successfull !!!!')
...
ver = urllib.request.urlopen(
    "https://raw.githubusercontent.com/1ucif3r/HxBomb/master/.version").read().decode('utf-8')
verl = ''
try:
...
try:
    noti = urllib.request.urlopen(
        "https://raw.githubusercontent.com/1ucif3r/HxBomb/master/.notify").read().decode('utf-8')
...
if nm == 0:
    ...
    print("==================================================================")
    print("              Use this for fun, not for revenge !!                ")
    print("              This Bomber Was Created By 1ucif3r !!                ")
    print("==================================================================")
    print(W)
